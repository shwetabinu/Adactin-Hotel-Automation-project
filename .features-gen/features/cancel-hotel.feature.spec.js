...
test.describe('Cancel Hotel functionality', () => {
  ...
  test('To verify successful booking cancelation', { tag: ['@cancelHotel', '@cancelHotelBookedItinerary'] }, async ({ Given, When, Then, bookedItineraryPage }) => { 
    ...
    await Then('The booked order "Q3S899T63G" should be canceled', null, { bookedItineraryPage }); 
  });
...
const bddFileData = [ // bdd-data-start
  {"pwTestLine":6,"pickleLine":5,"tags":["@cancelHotel","@cancelHotelBookedItinerary"],"steps":[{"pwStepLine":7,"gherkinStepLine":6,"keywordType":"Context","textWithKeyword":"Given I am in the booked itinerary page and an existing order is present in the page","stepMatchArguments":[]},{"pwStepLine":8,"gherkinStepLine":7,"keywordType":"Action","textWithKeyword":"When I select the order for cancelation and click on cancel button for \"orderid\"","stepMatchArguments":[{"group":{"start":66,"value":"\"orderid\"","children":[{"start":67,"value":"orderid","children":[{}]},{"children":[{}]}]},"parameterTypeName":"string"}]},{"pwStepLine":9,"gherkinStepLine":8,"keywordType":"Outcome","textWithKeyword":"Then The booked order \"Q3S899T63G\" should be canceled","stepMatchArguments":[{"group":{"start":17,"value":"\"Q3S899T63G\"","children":[{"start":18,"value":"Q3S899T63G","children":[{}]},{"children":[{}]}]},"parameterTypeName":"string"}]}]},
