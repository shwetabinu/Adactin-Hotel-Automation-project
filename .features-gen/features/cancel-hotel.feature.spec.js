...
test.describe('Cancel Hotel functionality', () => {
  ...
  test('To verify successful booking cancelation', { tag: ['@cancelHotel', '@cancelHotelBookedItinerary'] }, async ({ Given, When, Then, authenticatedLoginPage, bookedItineraryPage }) => { 
    await Given('I am in the booked itinerary page and an existing order is present in the page', null, { authenticatedLoginPage, bookedItineraryPage }); 
    await When('I select the first order for cancelation and click on its cancel button', null, { bookedItineraryPage }); 
